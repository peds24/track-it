...
import { FlatList, Linking, Modal, Platform, Pressable, StyleSheet, Text, TextInput, View } from 'react-native';
  ...
  function handleSendFeedback(): void {
    ...
    void (async () => {
      try {
        ...
        showAlert('No mail app found', `You can email your feedback to ${FEEDBACK_EMAIL}.`);
      }
    })();
  }
