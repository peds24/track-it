...
export default function TrackDetailScreen() {
  ...
  // history, so the header shows no back arrow and the screen is a dead end.
  // Offer a way to the tabs instead; native always arrives with history.
  const headerLeft = router.canGoBack()
    ? undefined
    : () => (
        <Pressable
          accessibilityRole="button"
          accessibilityLabel="Go to your tracks"
  ...
  function confirmComplete() {
    showAlert(`Mark ${track.title} complete?`, completionMessage(track), [
  ...
  function confirmBacklog() {
    ...
    showAlert(`Move ${track.title} to the backlog?`, 'Its progress will be cleared.', [
      { text: 'Cancel', style: 'cancel' },
  ...
  function confirmDelete() {
    ...
    showAlert(`Delete ${track.title}?`, body, [
      { text: 'Cancel', style: 'cancel' },
      {
        text: 'Delete',
        style: 'destructive',
        onPress: () =>
          void (async () => {
            try {
              ...
              // Web: a detail URL opened directly (bookmark, reload) has no
              // history, and back() would leave the user on a dead page.
  ...
  return (
    <View style={styles.screen}>
      <Stack.Screen options={{ title: track.title, headerLeft }} />
